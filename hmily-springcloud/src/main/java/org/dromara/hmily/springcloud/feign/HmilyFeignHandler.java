...
/**
 * HmilyFeignHandler. jdk 动态代理， 调用feign 时会进来
 *
 * @author xiaoyu
 */
public class HmilyFeignHandler implements InvocationHandler {
	...
	public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
		if (Object.class.equals(method.getDeclaringClass())) {
			...
			try {
				final HmilyTransactionContext hmilyTransactionContext = HmilyTransactionContextLocal.getInstance()
						.get();
				...
				final HmilyTransactionExecutor hmilyTransactionExecutor = SpringBeanUtils.getInstance()
						.getBean(HmilyTransactionExecutor.class);
				final Object invoke = delegate.invoke(proxy, method, args);
				final HmilyParticipant hmilyParticipant = buildParticipant(hmily, method, args,
	...
	private HmilyParticipant buildParticipant(final Hmily hmily, final Method method, final Object[] args,
		...
		HmilyInvocation confirmInvocation = new HmilyInvocation(declaringClass, confirmMethodName,
				method.getParameterTypes(), args);
		HmilyInvocation cancelInvocation = new HmilyInvocation(declaringClass, cancelMethodName,
				method.getParameterTypes(), args);
